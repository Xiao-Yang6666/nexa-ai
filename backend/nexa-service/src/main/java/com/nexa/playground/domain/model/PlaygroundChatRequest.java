package com.nexa.playground.domain.model;
...
public final class PlaygroundChatRequest {
     ...
     *
     * <p>必须在走 relay <b>之前</b>调用。access token 凭据 → {@link com.nexa.playground.domain.exception.PlaygroundAccessDeniedException}
     * （403「暂不支持使用 access token」）。</p>
     *
     * @throws com.nexa.playground.domain.exception.PlaygroundAccessDeniedException 凭据为 access token
     */
