package com.nexa.sensitiveverify.application;

import com.nexa.sensitiveverify.application.port.PasskeyVerificationPort;
import com.nexa.sensitiveverify.application.port.PasswordVerificationPort;
import com.nexa.sensitiveverify.application.port.TotpVerificationPort;
import com.nexa.sensitiveverify.domain.service.SensitiveActionVerifier;
...
public class VerifySensitiveActionUseCase {
     ...
     * {@link com.nexa.sensitiveverify.domain.exception.InvalidVerificationRequestException}（400）；
     * 提供了因子但无一通过抛
     * {@link com.nexa.sensitiveverify.domain.exception.SensitiveActionVerificationFailedException}（403）。
     * 三态裁决全部委托领域服务，保持单一规则源。</p>
     *
     * @param command 验证命令（会话用户 + 各因子凭据）
     * @throws com.nexa.sensitiveverify.domain.exception.InvalidVerificationRequestException        未提供任何因子
     * @throws com.nexa.sensitiveverify.domain.exception.SensitiveActionVerificationFailedException 因子均未通过
     */
