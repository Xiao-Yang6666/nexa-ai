...
public class SensitiveActionGuard {
     ...
     * @throws com.nexa.sensitiveverify.domain.exception.InvalidVerificationRequestException        未提供任何因子（400）
     * @throws com.nexa.sensitiveverify.domain.exception.SensitiveActionVerificationFailedException 因子均未通过（403）
     */
