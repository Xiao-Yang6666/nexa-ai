 ...
 */
public record ModelGroupAdminView(Long id, String name, String code, BigDecimal basePriceRatio,
     ...
     * @return 管理视图 DTO
     */
    public static ModelGroupAdminView from(ModelGroup g) {
        return new ModelGroupAdminView(
                g.id(),
                g.name(),
                g.code(),
