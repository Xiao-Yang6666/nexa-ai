package com.nexa.shared.security.application.port;
 ...
 *       {@link com.nexa.shared.security.domain.exception.AuthenticationRequiredException}
...
public interface TokenPrincipalResolver {
     ...
     * @throws com.nexa.shared.security.domain.exception.AuthenticationRequiredException 凭据存在但非法
     */
