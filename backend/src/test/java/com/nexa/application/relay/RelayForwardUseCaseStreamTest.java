...
import com.nexa.domain.relay.vo.LogType;
...
class RelayForwardUseCaseStreamTest {
    ...
    void setUp() {
        ...
        useCase = new RelayForwardUseCase(l1Repo, logRepo, upstreamHttpPort,
                ...
                new com.nexa.domain.relay.port.AccountSelectionPort() {
                    @Override public Optional<com.nexa.domain.relay.port.SelectedAccount> selectAccount(
                        ...
                        return Optional.of(new com.nexa.domain.relay.port.SelectedAccount(
        ...
        new com.nexa.infrastructure.relay.protocol.OpenAiProtocolAdapter(new ObjectMapper()).registerSelf();
    ...
    void streamDroppedAfterPartialDeliveryStillBills() {
        ...
        doAnswer(inv -> {
            ...
            h.onChunk(("data: {\"choices\":[{\"delta\":{\"content\":\"partial\"}}],"
                    ...
                    .getBytes(StandardCharsets.UTF_8));
            throw new com.nexa.domain.relay.exception.UpstreamException(
