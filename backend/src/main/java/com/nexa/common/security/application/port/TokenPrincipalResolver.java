package com.nexa.common.security.application.port;
 ...
 *       {@link com.nexa.common.security.domain.exception.AuthenticationRequiredException}
...
public interface TokenPrincipalResolver {
     ...
     * @throws com.nexa.common.security.domain.exception.AuthenticationRequiredException 凭据存在但非法
     */
