...
/**
 * 运营与运维统一 API 响应信封（接口层，对齐全站 {@code {success, message, data}} 约定）。
 *
 * <p>与 com.nexa.token / com.nexa.channel 等 bounded context 的 ApiResponse 同构（各 BC 接口层
 * 各自持有信封 DTO，避免跨 context 耦合）。成功时 {@code success=true} 载 data；业务/参数错误时
