 ...
 */
@Entity(name = "AccountAbilityJpaEntity")
...
public class AccountAbilityJpaEntity {
    ...
    public AccountAbilityJpaEntity() {
    }

    public AccountAbilityJpaEntity(Long accountId, String group, String models, String tag,
