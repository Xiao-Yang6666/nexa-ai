package com.nexa.account.infrastructure.pricing;

import com.nexa.account.domain.repository.UserRepository;
import com.nexa.relay.domain.port.UserDiscountPort;
 ...
 * {@link com.nexa.account.domain.model.User} 取其专属折扣 {@code discountRatio}。售价侧在分组倍率之后
