package com.nexa.account.domain.repository;
...
public interface OAuthBindingRepository {
     ...
     * {@link com.nexa.account.domain.exception.OAuthBindingConflictException}（不吞错）。</p>
     *
     * @param binding 待保存的绑定实体
     * @return 持久化后的绑定（含 id）
     * @throws com.nexa.account.domain.exception.OAuthBindingConflictException 唯一索引冲突
     */
