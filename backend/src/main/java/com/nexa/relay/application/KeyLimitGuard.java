...
import com.nexa.relay.domain.service.KeyLimitChecker;
...
public class KeyLimitGuard {
     ...
     * @throws com.nexa.relay.domain.exception.ModelMappingException     A 不在 key 模型允许集（启用时，403）
     * @throws com.nexa.relay.domain.exception.EndpointNotAllowedException inFmt 不在 key 端点允许集（启用时，403）
     */
