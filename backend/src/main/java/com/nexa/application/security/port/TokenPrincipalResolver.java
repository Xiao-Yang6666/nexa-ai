 ...
 *       {@link com.nexa.domain.security.exception.AuthenticationRequiredException}
...
public interface TokenPrincipalResolver {
     ...
     * @throws com.nexa.domain.security.exception.AuthenticationRequiredException 凭据存在但非法
     */
