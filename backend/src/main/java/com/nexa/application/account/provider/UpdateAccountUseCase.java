...
import com.nexa.application.account.provider.command.UpdateAccountCommand;
...
public class UpdateAccountUseCase {
     ...
     * @throws com.nexa.domain.account.provider.exception.InvalidAccountParameterException 字段非法
     */
    @Transactional
