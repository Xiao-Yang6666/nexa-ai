package com.nexa.growth.infrastructure.persistence.entity;
 ...
 * 且天然满足「全局唯一一份签到配置」。与领域值对象 {@link com.nexa.growth.domain.vo.CheckinSetting}
 * 分离，映射在 {@code CheckinSettingRepositoryImpl}。</p>
 */
@Entity
@Table(name = "checkin_settings")
public class CheckinSettingJpaEntity {
    ...
    /** JPA 规范要求的无参构造器。 */
    public CheckinSettingJpaEntity() {
    }
