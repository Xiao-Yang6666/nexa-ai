 ...
 */
public record CheckinSettingView(
     ...
     * @return 管理端视图
     */
    public static CheckinSettingView from(CheckinSetting setting) {
        return new CheckinSettingView(setting.enabled(), setting.minQuota(), setting.maxQuota());
    }
}
