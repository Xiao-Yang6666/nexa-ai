package com.nexa.interfaces.compliance.api.dto;
 ...
 */
public record AccountDeactivationVO(int tokensPurged,
     ...
     * @return 注销回执视图
     */
    public static AccountDeactivationVO from(AccountDeactivationCascade.CascadeResult r) {
        return new AccountDeactivationVO(
                r.tokensPurged(),
