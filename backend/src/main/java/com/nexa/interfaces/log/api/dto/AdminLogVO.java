 ...
 * channel/channel_name + upstream_request_id + other。与 {@link UserLogVO} 的差异即「客户看不到 B」
 * 三道闸之序列化层——AdminLogVO 是<b>唯一</b>下发 B/成本/利润的 DTO，由角色级端点（AdminAuth）守护。</p>
 *
 * <p>对齐 openapi components.schemas.AdminLogVO。SNAKE_CASE 全局策略下字段自动转下划线。</p>
 */
public record AdminLogVO(
     ...
     * @return 管理视图 DTO
     */
    public static AdminLogVO from(LogEntry log) {
