 ...
 */
public record QuotaDataItemVO(String date, long quota, long count, String modelName) {
     ...
     * @return 配额数据项视图 DTO
     */
    public static QuotaDataItemVO from(QuotaDataPoint point) {
        return new QuotaDataItemVO(point.date(), point.quota(), point.count(), point.modelName());
    }
}
