 ...
 *
 * <p>对齐 openapi components.schemas.RankingPublicView：{@code rank / public_model / used_quota_or_count /
 ...
 */
public record RankingPublicView(
        int rank,
        String publicModel,
     ...
     * @return 公开视图 DTO
     */
    public static RankingPublicView from(RankingEntry entry) {
        return new RankingPublicView(
                entry.rank(),
                entry.publicModel(),
                entry.usedQuota(),
                entry.period(),
