package com.nexa.interfaces.publicsite.api.dto;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.nexa.domain.publicsite.vo.SiteStatus;

/**
 * 营销首页公开状态聚合视图 DTO（对齐 openapi.yaml {@code StatusAggregateView}，F-4039）。
 *
 ...
 */
public record StatusAggregateView(
     ...
     * @return 公开状态视图 DTO
     */
    public static StatusAggregateView from(SiteStatus s) {
        return new StatusAggregateView(
                s.systemName(),
                s.logo(),
                s.footerHtml(),
                s.registerEnabled(),
