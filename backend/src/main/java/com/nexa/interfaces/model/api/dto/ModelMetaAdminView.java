 ...
 *
 * <p>对齐 openapi {@code ModelMetaAdminView}。模型元数据本身不含成本/上游模型 B/供应商凭证等敏感
 ...
 */
public record ModelMetaAdminView(Long id,
                                 String modelName,
                                 int status,
                                 String description,
                                 String icon,
     ...
     * @return 管理视图
     */
    public static ModelMetaAdminView from(ModelMeta m) {
        return new ModelMetaAdminView(
