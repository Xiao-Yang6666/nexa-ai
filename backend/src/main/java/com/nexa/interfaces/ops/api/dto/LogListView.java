...
public record LogListView(
     ...
     */
    public static LogListView disabled() {
        return new LogListView(false, null, null, null, null, null);
    }
     ...
     * @return 启用视图
     */
    public static LogListView enabled(List<LogFileManager.LogFileInfo> infos) {
        ...
        return new LogListView(true, files, files.size(), total, oldest, newest);
    }
