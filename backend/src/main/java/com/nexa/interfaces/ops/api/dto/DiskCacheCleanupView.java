 ...
 */
public record DiskCacheCleanupView(
     ...
     * @return 视图
     */
    public static DiskCacheCleanupView from(DiskCacheManager.CleanupResult result) {
        return new DiskCacheCleanupView(result.deletedCount(), result.freedBytes());
    }
}
