 ...
 */
public record PaymentComplianceVO(
     ...
     * @return 视图
     */
    public static PaymentComplianceVO from(PaymentComplianceConfirmation confirmation) {
        return new PaymentComplianceVO(confirmation.termsVersion(), confirmation.confirmedBy());
    }
}
