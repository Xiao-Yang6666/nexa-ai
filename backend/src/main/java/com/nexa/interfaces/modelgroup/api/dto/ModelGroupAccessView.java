 ...
 */
public record ModelGroupAccessView(Long id, long modelGroupId, String subjectType,
     ...
     * @return 视图 DTO
     */
    public static ModelGroupAccessView from(ModelGroupAccess a) {
        return new ModelGroupAccessView(
                a.id(),
                a.modelGroupId(),
