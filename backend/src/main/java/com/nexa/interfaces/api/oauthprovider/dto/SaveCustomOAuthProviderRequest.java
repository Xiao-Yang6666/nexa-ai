...
/**
 * 创建/更新自定义 OAuth provider 请求 DTO（对齐 openapi {@code CustomOAuthProviderVO} 写入语义，F-1024）。
 *
 * <p>字段与 {@link CustomOAuthProviderVO} 同形，但写入额外携带敏感的 {@code clientSecret}
 ...
 * 是对契约写入语义的必要补全，不改变回显视图（{@link CustomOAuthProviderVO} 仍零密钥）。</p>
 *
