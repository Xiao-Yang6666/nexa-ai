package com.nexa.interfaces.api.passkey.dto;

import com.nexa.domain.passkey.model.PasskeyCredential;

/**
 * Passkey 客户视图 DTO（对齐 openapi.yaml {@code PasskeyVO}，本人状态查询返回，F-1031）。
 *
...
public record PasskeyVO(
     ...
     */
    public static PasskeyVO from(PasskeyCredential credential) {
        return new PasskeyVO(
                credential.id(),
