 ...
 */
public record ModelSyncResultVO(int createdModels,
                                  int createdVendors,
                                  int updatedModels,
                                  int skippedModels) {
     ...
     * @return 结果视图
     */
    public static ModelSyncResultVO from(ModelSyncResult r) {
        return new ModelSyncResultVO(r.createdModels(), r.createdVendors(),
