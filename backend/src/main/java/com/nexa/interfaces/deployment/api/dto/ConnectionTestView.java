 ...
 */
public record ConnectionTestView(int hardwareCount, long totalAvailable) {
     ...
     * @return 出参视图
     */
    public static ConnectionTestView from(ConnectionTestResult result) {
        return new ConnectionTestView(result.hardwareCount(), result.totalAvailable());
    }
}
