 ...
 */
public record NameAvailabilityView(boolean available, String name) {
     ...
     * @return 出参视图
     */
    public static NameAvailabilityView from(NameAvailability na) {
        return new NameAvailabilityView(na.available(), na.name());
    }
}
