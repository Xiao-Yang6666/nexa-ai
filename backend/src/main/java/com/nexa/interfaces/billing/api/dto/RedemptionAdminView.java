...
/**
 * 兑换码管理视图（管理端出参，对齐 openapi {@code RedemptionAdminView}）。
 *
 ...
 */
public record RedemptionAdminView(Long id, String name, String key, int status, long quota,
     ...
     * @return 管理视图 DTO
     */
    public static RedemptionAdminView from(Redemption r) {
        return new RedemptionAdminView(
