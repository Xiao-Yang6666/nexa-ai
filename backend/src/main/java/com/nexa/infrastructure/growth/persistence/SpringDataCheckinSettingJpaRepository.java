 ...
 * {@link CheckinSettingPO#SINGLETON_ID}），用 {@code findById(1)} 读、{@code save} 覆盖写。</p>
 */
interface SpringDataCheckinSettingJpaRepository extends JpaRepository<CheckinSettingPO, Long> {
}
