...
import com.nexa.model.application.QueryPublicPricingUseCase;
 ...
 * ({@link QueryPublicPricingUseCase}) + DTO ({@link PricingPublicView}) 负责——成本/利润/上游模型 B/
...
public class PricingController {
     ...
     */
    @GetMapping
    public ApiResponse<PricingPublicView> pricing(
