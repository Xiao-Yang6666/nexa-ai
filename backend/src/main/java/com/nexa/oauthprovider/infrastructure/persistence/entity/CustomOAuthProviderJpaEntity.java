package com.nexa.oauthprovider.infrastructure.persistence.entity;
 ...
 *
 * <p>持久化映射，与领域聚合 {@link com.nexa.oauthprovider.domain.model.CustomOAuthProvider} 分离
...
public class CustomOAuthProviderJpaEntity {
    ...
    /** JPA 规范要求的无参构造器。 */
    public CustomOAuthProviderJpaEntity() {
    }
