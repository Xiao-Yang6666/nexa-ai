...
public interface UpstreamHttpPort {
     ...
     * 响应的情形）抛 {@link com.nexa.domain.relay.exception.UpstreamException}（不吞错），HTTP 层错误
     ...
     * @throws com.nexa.domain.relay.exception.UpstreamException 网络层失败 / 无法取得 HTTP 响应
     */
     ...
     * {@link com.nexa.domain.relay.exception.UpstreamException}。</p>
     *
     * @param request 出站请求（body 中 {@code stream=true}）
     * @param handler 逐块回调（onChunk/onComplete/onError）
     * @throws com.nexa.domain.relay.exception.UpstreamException 网络层失败
     */
