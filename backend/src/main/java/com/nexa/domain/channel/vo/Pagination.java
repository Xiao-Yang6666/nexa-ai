package com.nexa.domain.channel.vo;

/**
 * 分页参数值对象（渠道列表/搜索，与 com.nexa.domain.deployment.vo.Pagination 同构）。
 *
 * <p>领域规则来源：openapi PageParam/PageSizeParam（F-2016 渠道列表、F-2016 搜索）。
 * 非正/越界由工厂 {@link #of(Integer, Integer)} 归一（缺省页 1、每页 10、上限 100），不报错——
 * 分页是查询便利参数，宽容归一优于抛错（与 deployment 模块一致）。</p>
 *
