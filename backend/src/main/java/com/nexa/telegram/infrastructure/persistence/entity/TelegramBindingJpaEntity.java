package com.nexa.telegram.infrastructure.persistence.entity;
 ...
 *
 * <p>本实体是<b>持久化映射</b>，与领域实体 {@link com.nexa.telegram.domain.model.TelegramBinding} 分离
...
public class TelegramBindingJpaEntity {
    ...
    /** JPA 规范要求的无参构造器。 */
    public TelegramBindingJpaEntity() {
    }
